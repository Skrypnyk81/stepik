...
по убыванию калорийности. В случае, если продукты имеют одинаковую калорийность - упорядочите их по названию. 
...
for i in range(sheet.nrows):
    str = sheet.cell_value(i, 0), sheet.cell_value(i, 1)
    lst.append(str)
del lst[0]
sorte = sorted(lst, key=lambda item: (-item[1], item[0]))
for i in sorte:
    print(i[0])
